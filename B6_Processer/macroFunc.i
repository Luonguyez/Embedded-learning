...
# 35 "macroFunc.c"
void test1() { printf("%s", (char *)"This is a new Func1\n"); };
void abc() { printf("%s", (char *)"1 +1\n"); };
void tong() { printf("%d", 1+1 ); };
void Tich() { printf("%d", 2*3 ); };
...
int main()
{
    ...
    abc();
    tong();
    int name__var1;int name__var2;int name__var3;;
    int a, int b, int c;;
